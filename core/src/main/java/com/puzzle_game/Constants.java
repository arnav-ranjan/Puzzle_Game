...
public final class Constants {
    ...
    public static final int[] stage3Plats = {-55, -53, 
     ...
     public static final int[] stage3speeds = {100, 100, 21, -28, -38, 17};
